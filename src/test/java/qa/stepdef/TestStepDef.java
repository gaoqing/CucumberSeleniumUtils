...
public class TestStepDef {
    ...
    public TestStepDef(DriverUtils driveUtils, PageObject pageObj) {
    ...
    public void user_can_log_into_the_application_as_expected() {
        ...
        driver.get(Config.testAppUrl);
        Reporter.writeText("Getting to site: " + Config.testAppUrl);
    }
...
//	ObjectHelper helper;
//
//	public TestStepDef(ObjectHelper helper) {
//		this.helper = helper;
//	}
//
//	@Given("^User can open github site and do a search$")
